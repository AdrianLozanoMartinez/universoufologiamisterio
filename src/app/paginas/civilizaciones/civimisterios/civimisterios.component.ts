...
@Component({
  selector: 'app-civimisterios',
  templateUrl: './civimisterios.component.html',
  styleUrls: ['./civimisterios.component.css']
})
export class CivimisteriosComponent implements OnInit {
