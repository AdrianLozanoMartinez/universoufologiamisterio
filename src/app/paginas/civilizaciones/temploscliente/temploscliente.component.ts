...
@Component({
  selector: 'app-temploscliente',
  templateUrl: './temploscliente.component.html',
  styleUrls: ['./temploscliente.component.css']
})
export class TemplosclienteComponent implements OnInit {
 ...
 /*jd: JdModel[] = []; 
  ...
  this.db.collection('templos').valueChanges().subscribe((resultado)=>{//   --> VIDEO COMPRADO
