...
@Component({
  selector: 'app-mitologiacliente',
  templateUrl: './mitologiacliente.component.html',
  styleUrls: ['./mitologiacliente.component.css']
})
export class MitologiaclienteComponent implements OnInit {
  ...
  this.db.collection('mitologia').valueChanges().subscribe((resultado)=>{//   --> VIDEO COMPRADO
