...
@Component({
  selector: 'app-templosadministrador',
  templateUrl: './templosadministrador.component.html',
  styleUrls: ['./templosadministrador.component.css']
})
export class TemplosadministradorComponent implements OnInit {
    /*jd = new JdModel();   
...
agregar(){
  ...
  // ;
  this.db.collection('templos').add(this.formularioCliente.value).then((termino)=>{
...
subirImagen(evento){
  if(evento.target.files.length>0){
    ...
    let ruta = 'templos/'+nombre+extension;
