...
@Component({
  selector: 'app-civimisteriosadministrador',
  templateUrl: './civimisteriosadministrador.component.html',
  styleUrls: ['./civimisteriosadministrador.component.css']
})
export class CivimisteriosadministradorComponent implements OnInit {
...
agregar(){
  ...
  // ;
  this.db.collection('civimisterios').add(this.formularioCliente.value).then((termino)=>{
...
subirImagen(evento){
  if(evento.target.files.length>0){
    ...
    let ruta = 'civimisterios/'+nombre+extension;
