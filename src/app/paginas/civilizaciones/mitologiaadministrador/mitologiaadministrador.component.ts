...
@Component({
  selector: 'app-mitologiaadministrador',
  templateUrl: './mitologiaadministrador.component.html',
  styleUrls: ['./mitologiaadministrador.component.css']
})
export class MitologiaadministradorComponent implements OnInit {
...
agregar(){
  ...
  // ;
  this.db.collection('mitologia').add(this.formularioCliente.value).then((termino)=>{
...
subirImagen(evento){
  if(evento.target.files.length>0){
    ...
    let ruta = 'mitologia/'+nombre+extension;
