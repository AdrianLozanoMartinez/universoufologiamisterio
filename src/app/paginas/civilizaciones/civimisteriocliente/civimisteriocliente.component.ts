...
@Component({
  selector: 'app-civimisteriocliente',
  templateUrl: './civimisteriocliente.component.html',
  styleUrls: ['./civimisteriocliente.component.css']
})
export class CivimisterioclienteComponent implements OnInit {
