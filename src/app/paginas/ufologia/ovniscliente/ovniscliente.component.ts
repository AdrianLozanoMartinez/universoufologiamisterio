...
@Component({
  selector: 'app-ovniscliente',
  templateUrl: './ovniscliente.component.html',
  styleUrls: ['./ovniscliente.component.css']
})
export class OvnisclienteComponent implements OnInit {
 ...
 /*jd: JdModel[] = []; 
  ...
  this.db.collection('ovnis').valueChanges().subscribe((resultado)=>{//   --> VIDEO COMPRADO
