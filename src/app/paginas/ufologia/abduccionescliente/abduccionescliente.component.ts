...
@Component({
  selector: 'app-abduccionescliente',
  templateUrl: './abduccionescliente.component.html',
  styleUrls: ['./abduccionescliente.component.css']
})
export class AbduccionesclienteComponent implements OnInit {
 ...
 /*jd: JdModel[] = []; 
  ...
  this.db.collection('abducciones').valueChanges().subscribe((resultado)=>{//   --> VIDEO COMPRADO
