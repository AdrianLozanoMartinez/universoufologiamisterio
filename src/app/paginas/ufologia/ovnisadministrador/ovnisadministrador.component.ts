...
@Component({
  selector: 'app-ovnisadministrador',
  templateUrl: './ovnisadministrador.component.html',
  styleUrls: ['./ovnisadministrador.component.css']
})
export class OvnisadministradorComponent implements OnInit {
...
agregar(){
  ...
  // ;
  this.db.collection('ovnis').add(this.formularioCliente.value).then((termino)=>{
...
subirImagen(evento){
  if(evento.target.files.length>0){
    ...
    let ruta = 'ovnis/'+nombre+extension;
