...
@Component({
  selector: 'app-archivosadministrador',
  templateUrl: './archivosadministrador.component.html',
  styleUrls: ['./archivosadministrador.component.css']
})
...
agregar(){
  ...
  // ;
  this.db.collection('archivos').add(this.formularioCliente.value).then((termino)=>{
...
subirImagen(evento){
  if(evento.target.files.length>0){
    ...
    let ruta = 'archivos/'+nombre+extension;
