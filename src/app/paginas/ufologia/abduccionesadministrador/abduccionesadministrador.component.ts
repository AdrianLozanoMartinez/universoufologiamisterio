...
@Component({
  selector: 'app-abduccionesadministrador',
  templateUrl: './abduccionesadministrador.component.html',
  styleUrls: ['./abduccionesadministrador.component.css']
})
export class AbduccionesadministradorComponent implements OnInit {
...
agregar(){
  ...
  // ;
  this.db.collection('abducciones').add(this.formularioCliente.value).then((termino)=>{
...
subirImagen(evento){
  if(evento.target.files.length>0){
    ...
    let ruta = 'abducciones/'+nombre+extension;
