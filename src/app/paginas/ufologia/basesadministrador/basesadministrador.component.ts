...
@Component({
  selector: 'app-basesadministrador',
  templateUrl: './basesadministrador.component.html',
  styleUrls: ['./basesadministrador.component.css']
})
export class BasesadministradorComponent implements OnInit {
...
agregar(){
  ...
  // ;
  this.db.collection('bases').add(this.formularioCliente.value).then((termino)=>{
...
subirImagen(evento){
  if(evento.target.files.length>0){
    ...
    let ruta = 'bases/'+nombre+extension;
