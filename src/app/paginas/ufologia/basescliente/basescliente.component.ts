...
@Component({
  selector: 'app-basescliente',
  templateUrl: './basescliente.component.html',
  styleUrls: ['./basescliente.component.css']
})
export class BasesclienteComponent implements OnInit {
 ...
 /*jd: JdModel[] = []; 
  ...
  this.db.collection('bases').valueChanges().subscribe((resultado)=>{//   --> VIDEO COMPRADO
