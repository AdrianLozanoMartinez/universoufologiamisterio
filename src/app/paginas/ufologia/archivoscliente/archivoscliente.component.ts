...
@Component({
  selector: 'app-archivoscliente',
  templateUrl: './archivoscliente.component.html',
  styleUrls: ['./archivoscliente.component.css']
})
export class ArchivosclienteComponent implements OnInit {
 ...
 /*jd: JdModel[] = []; 
  ...
  this.db.collection('archivos').valueChanges().subscribe((resultado)=>{//   --> VIDEO COMPRADO
