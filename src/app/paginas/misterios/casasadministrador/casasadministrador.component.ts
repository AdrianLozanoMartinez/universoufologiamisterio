...
@Component({
  selector: 'app-casasadministrador',
  templateUrl: './casasadministrador.component.html',
  styleUrls: ['./casasadministrador.component.css']
})
export class CasasadministradorComponent implements OnInit {
/*jd = new JdModel();   
...
agregar(){
  ...
  // ;
  this.db.collection('casas').add(this.formularioCliente.value).then((termino)=>{
...
subirImagen(evento){
  if(evento.target.files.length>0){
    ...
    let ruta = 'casas/'+nombre+extension;
