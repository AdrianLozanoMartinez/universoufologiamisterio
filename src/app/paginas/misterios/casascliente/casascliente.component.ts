...
@Component({
  selector: 'app-casascliente',
  templateUrl: './casascliente.component.html',
  styleUrls: ['./casascliente.component.css']
})
export class CasasclienteComponent implements OnInit {
/*jd: JdModel[] = []; 
  ...
  this.db.collection('casas').valueChanges().subscribe((resultado)=>{//   --> VIDEO COMPRADO
