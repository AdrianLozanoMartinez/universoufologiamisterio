...
@Component({
  selector: 'app-viajesadministrador',
  templateUrl: './viajesadministrador.component.html',
  styleUrls: ['./viajesadministrador.component.css']
})
export class ViajesadministradorComponent implements OnInit {
...
agregar(){
  ...
  // ;
  this.db.collection('viajes').add(this.formularioCliente.value).then((termino)=>{
...
subirImagen(evento){
  if(evento.target.files.length>0){
    ...
    let ruta = 'viajes/'+nombre+extension;
