...
@Component({
  selector: 'app-espiritusadministrador',
  templateUrl: './espiritusadministrador.component.html',
  styleUrls: ['./espiritusadministrador.component.css']
})
export class EspiritusadministradorComponent implements OnInit {
...
agregar(){
  ...
  // ;
  this.db.collection('espiritus').add(this.formularioCliente.value).then((termino)=>{
...
subirImagen(evento){
  if(evento.target.files.length>0){
    ...
    let ruta = 'espiritus/'+nombre+extension;
