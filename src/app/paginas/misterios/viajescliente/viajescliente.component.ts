...
@Component({
  selector: 'app-viajescliente',
  templateUrl: './viajescliente.component.html',
  styleUrls: ['./viajescliente.component.css']
})
export class ViajesclienteComponent implements OnInit {
 ...
 /*jd: JdModel[] = []; 
  ...
  this.db.collection('viajes').valueChanges().subscribe((resultado)=>{//   --> VIDEO COMPRADO
