...
@Component({
  selector: 'app-espirituscliente',
  templateUrl: './espirituscliente.component.html',
  styleUrls: ['./espirituscliente.component.css']
})
export class EspiritusclienteComponent implements OnInit {
/*jd: JdModel[] = []; 
  ...
  this.db.collection('espiritus').valueChanges().subscribe((resultado)=>{//   --> VIDEO COMPRADO
