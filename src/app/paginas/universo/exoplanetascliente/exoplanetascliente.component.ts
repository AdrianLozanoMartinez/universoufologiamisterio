...
@Component({
  selector: 'app-exoplanetascliente',
  templateUrl: './exoplanetascliente.component.html',
  styleUrls: ['./exoplanetascliente.component.css']
})
export class ExoplanetasclienteComponent implements OnInit {
 ...
 /*jd: JdModel[] = []; 
  ...
  this.db.collection('exoplanetas').valueChanges().subscribe((resultado)=>{//   --> VIDEO COMPRADO
