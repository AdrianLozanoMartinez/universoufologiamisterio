...
@Component({
  selector: 'app-lunaadministrador',
  templateUrl: './lunaadministrador.component.html',
  styleUrls: ['./lunaadministrador.component.css']
})
export class LunaadministradorComponent implements OnInit {
...
agregar(){
  ...
  // ;
  this.db.collection('luna').add(this.formularioCliente.value).then((termino)=>{
...
subirImagen(evento){
  if(evento.target.files.length>0){
    ...
    let ruta = 'luna/'+nombre+extension;
