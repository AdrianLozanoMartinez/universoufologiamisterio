...
@Component({
  selector: 'app-gusanocliente',
  templateUrl: './gusanocliente.component.html',
  styleUrls: ['./gusanocliente.component.css']
})
export class GusanoclienteComponent implements OnInit {
 ...
 /*jd: JdModel[] = []; 
  ...
  this.db.collection('gusano').valueChanges().subscribe((resultado)=>{//   --> VIDEO COMPRADO
