...
@Component({
  selector: 'app-negrocliente',
  templateUrl: './negrocliente.component.html',
  styleUrls: ['./negrocliente.component.css']
})
export class NegroclienteComponent implements OnInit {
 ...
 /*jd: JdModel[] = []; 
  ...
  this.db.collection('negro').valueChanges().subscribe((resultado)=>{//   --> VIDEO COMPRADO
