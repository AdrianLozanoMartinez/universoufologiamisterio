...
@Component({
  selector: 'app-exoplanetasadministrador',
  templateUrl: './exoplanetasadministrador.component.html',
  styleUrls: ['./exoplanetasadministrador.component.css']
})
export class ExoplanetasadministradorComponent implements OnInit {
...
agregar(){
  ...
  // ;
  this.db.collection('exoplanetas').add(this.formularioCliente.value).then((termino)=>{
...
subirImagen(evento){
  if(evento.target.files.length>0){
    ...
    let ruta = 'exoplanetas/'+nombre+extension;
