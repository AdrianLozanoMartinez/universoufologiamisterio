...
@Component({
  selector: 'app-gusanoadministrador',
  templateUrl: './gusanoadministrador.component.html',
  styleUrls: ['./gusanoadministrador.component.css']
})
export class GusanoadministradorComponent implements OnInit {
...
agregar(){
  ...
  // ;
  this.db.collection('gusano').add(this.formularioCliente.value).then((termino)=>{
...
subirImagen(evento){
  if(evento.target.files.length>0){
    ...
    let ruta = 'gusano/'+nombre+extension;
