...
@Component({
  selector: 'app-marteadministrador',
  templateUrl: './marteadministrador.component.html',
  styleUrls: ['./marteadministrador.component.css']
})
export class MarteadministradorComponent implements OnInit {
...
agregar(){
  ...
  // ;
  this.db.collection('marte').add(this.formularioCliente.value).then((termino)=>{
...
subirImagen(evento){
  if(evento.target.files.length>0){
    ...
    let ruta = 'marte/'+nombre+extension;
