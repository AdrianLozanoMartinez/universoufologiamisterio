...
@Component({
  selector: 'app-lunacliente',
  templateUrl: './lunacliente.component.html',
  styleUrls: ['./lunacliente.component.css']
})
export class LunaclienteComponent implements OnInit {
 ...
 /*jd: JdModel[] = []; 
  ...
  this.db.collection('luna').valueChanges().subscribe((resultado)=>{//   --> VIDEO COMPRADO
