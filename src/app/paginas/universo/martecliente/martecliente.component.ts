...
@Component({
  selector: 'app-martecliente',
  templateUrl: './martecliente.component.html',
  styleUrls: ['./martecliente.component.css']
})
export class MarteclienteComponent implements OnInit {
 ...
 /*jd: JdModel[] = []; 
  ...
  this.db.collection('marte').valueChanges().subscribe((resultado)=>{//   --> VIDEO COMPRADO
