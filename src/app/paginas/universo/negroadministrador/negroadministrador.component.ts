...
@Component({
  selector: 'app-negroadministrador',
  templateUrl: './negroadministrador.component.html',
  styleUrls: ['./negroadministrador.component.css']
})
export class NegroadministradorComponent implements OnInit {
...
agregar(){
  ...
  // ;
  this.db.collection('negro').add(this.formularioCliente.value).then((termino)=>{
...
subirImagen(evento){
  if(evento.target.files.length>0){
    ...
    let ruta = 'negro/'+nombre+extension;
