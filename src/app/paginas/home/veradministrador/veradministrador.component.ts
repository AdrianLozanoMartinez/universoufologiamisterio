...
@Component({
  selector: 'app-veradministrador',
  templateUrl: './veradministrador.component.html',
  styleUrls: ['./veradministrador.component.css']
})
export class VeradministradorComponent implements OnInit {
 ...
 /* borrarUnElemento(  VariableModel: JdModel, i: number ){                       
  ...
  this.db.collection('ultimasnoticias').valueChanges().subscribe((resultado)=>{//   --> VIDEO COMPRADO
    this.clientes=resultado;
  })
  }
}