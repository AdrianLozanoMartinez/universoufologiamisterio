...
@Component({
  selector: 'app-corrupcionadministrador',
  templateUrl: './corrupcionadministrador.component.html',
  styleUrls: ['./corrupcionadministrador.component.css']
})
export class CorrupcionadministradorComponent implements OnInit {
  /*jd = new JdModel();   
...
agregar(){
  ...
  // ;
  this.db.collection('corrupcion').add(this.formularioCliente.value).then((termino)=>{
...
subirImagen(evento){
  if(evento.target.files.length>0){
    ...
    let ruta = 'corrupcion/'+nombre+extension;
