...
@Component({
  selector: 'app-corrupcioncliente',
  templateUrl: './corrupcioncliente.component.html',
  styleUrls: ['./corrupcioncliente.component.css']
})
export class CorrupcionclienteComponent implements OnInit {
 /*jd: JdModel[] = []; 
