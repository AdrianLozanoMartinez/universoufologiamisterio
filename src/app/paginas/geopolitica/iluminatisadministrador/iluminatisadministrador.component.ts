...
@Component({
  selector: 'app-iluminatisadministrador',
  templateUrl: './iluminatisadministrador.component.html',
  styleUrls: ['./iluminatisadministrador.component.css']
})
export class IluminatisadministradorComponent implements OnInit {
/*jd = new JdModel();   
...
agregar(){
  ...
  // ;
  this.db.collection('iluminatis').add(this.formularioCliente.value).then((termino)=>{
...
subirImagen(evento){
  if(evento.target.files.length>0){
    ...
    let ruta = 'iluminatis/'+nombre+extension;
